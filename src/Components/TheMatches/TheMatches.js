                    ...
                    <div className="left">
                        <div className="match_filters">
                            <div className="match_filters_box">
                                ...
                                <div className="cont">
                                    <div className={`option ${this.state.playerFilter === 'All'? 'active':''} `}
                                        onClick={() => this.showPlayed('All')}
                                    >
                                        All 
                                    </div>
                                    <div className={`option ${this.state.playerFilter === 'Yes'? 'active':''} `}
                                        onClick={() => this.showPlayed('Yes')}
                                    >
                                        played
                                    </div>
                                    <div className={`option ${this.state.playerFilter === 'No'? 'active':''} `}
